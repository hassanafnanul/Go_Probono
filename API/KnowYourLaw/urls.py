...
urlpatterns = [
    path('', views.KylAPI.as_view(), name='KylAPI'), # First 10 will be visible
    ...
    # path('search/', views.SearchKylAPI.as_view(), name='SearchKylAPI'), # If search is number it will get all kyl from law of that ID, else search in question
]