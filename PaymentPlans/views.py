...
@login_required
@view_permission_required
def PaymentPlansAdd(request, task_url="TeamManagement", action="add"):
...
@login_required
@view_permission_required
def PaymentPlansEdit(request, id, task_url="TeamManagement", action="edit"):
    if request.method == 'POST':
        r = request.POST
        name = string.capwords(r.get('name'))
        order = r.get('order')
...
@login_required
@view_permission_required
def PaymentPlansView(request, id, task_url="TeamManagement", action="view"):
